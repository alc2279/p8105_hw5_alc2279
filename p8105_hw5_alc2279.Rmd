...
homocide_prop2 = function(x = unsolved_homocides, y = total_homocides) {
  homocide_prop_test = prop.test(x, y, 
            alternative = "two.sided", conf.level = 0.95, correct = FALSE)
...
homocide_data_nest[[2]]

output = map_2(homocide_data_nest, homocide_prop2(.x = unsolved_homocides, .y = total_homocides))

output = map(homicide_data, homicide_prop)
```
